...
class TestsDay15: XCTestCase {
    ...
    let input = Array(Input.array(seperator: "\n", file: "Day15", bundle: .twentyTwentyTwo, compactmap:  { string in string } ).dropLast())
        
    let example = Array(Input.array(seperator: "\n", file: "Day15Example", bundle: .twentyTwentyTwo, compactmap:  { string in string } ).dropLast())

    let pj = Array(Input.array(seperator: "\n", file: "Day15PJ", bundle: .twentyTwentyTwo, compactmap:  { string in string } ).dropLast())
