...
class TestsDay7: XCTestCase {
    ...
    let input = Array(Input.array(seperator: ",", file: "Day7", bundle: .twentyTwentyTwo, compactmap:  { string in Int(string.replacingOccurrences(of: "\n", with: ""))! } ))
        
    let example = Array(Input.array(seperator: ",", file: "Day7Example", bundle: .twentyTwentyTwo, compactmap:  { string in Int(string.replacingOccurrences(of: "\n", with: ""))! } ))
