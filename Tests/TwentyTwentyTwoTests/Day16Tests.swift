...
class TestsDay16: XCTestCase {
    ...
    let input = Input.getInputString(name: "Day16", bundle: .twentyTwentyTwo)
        
    let example =  Input.getInputString(name: "Day16Example", bundle: .twentyTwentyTwo)
    let example2 =  Input.getInputString(name: "Day16Example2", bundle: .twentyTwentyTwo)
    let example3 =  Input.getInputString(name: "Day16Example3", bundle: .twentyTwentyTwo)
    let example4 =  Input.getInputString(name: "Day16Example4", bundle: .twentyTwentyTwo)
    let example5 =  Input.getInputString(name: "Day16Example5", bundle: .twentyTwentyTwo)
